...
#define PROGRAM_VERSION_MAINTENANCE		10
#define PROGRAM_VERSION_BUILD					1

#define PROGRAM_VERSION_STRING "2.10.10.1 FCAMOD"
#define SCRAPER_VERSION_STRING "2.10.10.1"

#define PROGRAM_BUILT_STRING __DATE__ " - " __TIME__

#define RESOURCE_VERSION_STRING "2,10,10,1\0"
